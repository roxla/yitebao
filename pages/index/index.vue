	...
	<view id="INDEX">
		<scroll-view scroll-y :style="'height:'+height+'px'" v-if="reconnect">
			...
			<view class="index_item">
				<view class="index_item_item" @click="goRouter">
					<view class="index_item_box">
						<view class="index_item_img">
							<image src="../../static/index/u10410.png" mode=""></image>
						</view>
						<view class="index_item_text">领券中心</view>
					</view>
				</view>
				<view class="index_item_item" @click="goLink">
					<view class="index_item_box">
						<view class="index_item_img">
							<image src="../../static/index/u10417.png" mode=""></image>
						</view>
						<view class="index_item_text">会员办理</view>
					</view>
				</view>
				<view class="index_item_item">
					<view class="index_item_box">
						<view class="index_item_img">
							<image src="../../static/index/u10427.png" mode=""></image>
						</view>
						<view class="index_item_text">团洗入口</view>
					</view>
				</view>
				<view class="index_item_item">
					<view class="index_item_box">
						<view class="index_item_img">
							<image src="../../static/index/u10422.png" mode=""></image>
						</view>
						<view class="index_item_text">店铺介绍</view>
					</view>
				</view>
			</view>
...
export default {
	...
	methods: {
		...
		goLink: function () {
			uni.reLaunch({
				url:'../vipcard/vipcard?type=index'
			})
		}
	}
}
